...
class RestaurantProductsCreateController extends GetxController{
  ...
  void createProduct(BuildContext context)async{
    ...
    debugPrint('PRODUCT CATEGORY: $idCategory');
  ...
  bool isValidForm(String name, String description, String price){
    if(name.isEmpty){
      Get.snackbar('Formulario inválido', 'Ingresa el nombre del producto');
      return false;
    }
    if(description.isEmpty){
      Get.snackbar("Formulario inválido", "Debes ingresar la descripción del producto");
      return false;
    }
    if(price.isEmpty){
      Get.snackbar('Formulario inválido', "Debes ingresr el precio del producto");
      return false;
    }
    if(idCategory.value == ''){
      Get.snackbar('Formulario inválido', 'Debes seleccionar la categoría del producto');
      return false;
    }
    if(imageFile1 == null){
      Get.snackbar('Formulario inválido', 'Selecciona la imagen número 1 del producto');
      return false;
    }
    if(imageFile2 == null){
      Get.snackbar('Formulario inválido', 'Selecciona la imagen número 2 del producto');
      return false;
    }
    if(imageFile3 == null){
      Get.snackbar('Formulario inválido', 'Selecciona la imagen número 3 del producto');
      return false;
    }
    return true;
  }
